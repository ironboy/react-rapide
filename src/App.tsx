export default function App() {
  return <>
    ...
    <pre>
      ...
      <br />
      TO DO:<br />
      * This should install a little differenlty than other examples, not replacing the source folder or public folder entirely... rather just giving you the files you need.<br />
